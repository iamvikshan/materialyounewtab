...
async function initializeClock() {
  ...
  document.getElementById('second').style.transform =
    `rotate(${cumulativeSecondRotation}deg)`;
  document.getElementById('minute').style.transform =
    `rotate(${cumulativeMinuteRotation}deg)`;
  document.getElementById('hour').style.transform =
    `rotate(${cumulativeHourRotation}deg)`;
  ...
  function updateDate() {
    if (clocktype === 'analog') {
      ...
      var dayName =
        ...
        translations['en'].days[dayOfWeek];
      ...
      var localizedDayOfMonth = localizeNumbers(
        dayOfMonth.toString(),
        currentLanguage
      );
      ...
      document.getElementById('date').innerText =
        dateDisplay[currentLanguage] || dateDisplay.default;
    }
  }
  ...
  function updatedigiClock() {
    ...
    const isGreetingEnabled =
      localStorage.getItem('greetingEnabled') === 'true';
    ...
    // Localize the day of the month
    const localizedDayOfMonth = localizeNumbers(
      dayOfMonth.toString(),
      currentLanguage
    );
    ...
    const locale =
      specialLanguages.includes(currentLanguage) ||
      localizedLanguages.includes(currentLanguage)
        ? 'en-US'
        : currentLanguage;

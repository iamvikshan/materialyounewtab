...
function alertPrompt(message, isAlert = true, okText, cancelText) {
  return new Promise(resolve => {
    ...
    if (isAlert) {
      okText =
        okText ||
        translations[currentLanguage]?.okText ||
        translations['en'].okText;
    } else {
      okText =
        okText ||
        translations[currentLanguage]?.yesText ||
        translations['en'].yesText;
      cancelText =
        cancelText ||
        translations[currentLanguage]?.noText ||
        translations['en'].noText;
    }
...
const agreeText =
  translations[currentLanguage]?.agreeText || translations['en'].agreeText;
const cancelText =
  translations[currentLanguage]?.cancelText || translations['en'].cancelText;

  ...
  async function fetchWeather() {
    try {
      ...
      function UpdateWeather() {
        ...
        // Mapping WeatherAPI conditions to Weather Icons classes
        const weatherIconMappings = {
          ...
          143: "wi-fog", // Mist
          176: "wi-day-rain", // Patchy rain possible
          ...
          281: "wi-rain-mix", // Freezing drizzle
          284: "wi-rain-mix", // Heavy freezing drizzle
          293: "wi-day-showers", // Patchy light rain
          296: "wi-day-showers", // Light rain
          299: "wi-day-rain", // Moderate rain at times
          302: "wi-rain", // Moderate rain
          305: "wi-rain", // Heavy rain at times
          308: "wi-rain", // Heavy rain
          311: "wi-rain-mix", // Light freezing rain
          314: "wi-rain-mix", // Moderate or heavy freezing rain
          ...
          386: "wi-day-thunderstorm", // Patchy light rain with thunder
          ...
          // Night icons (same codes but with night prefix)
          "122_n": "wi-night-clear", // Clear
          "113_n": "wi-night-clear", // Clear
          "116_n": "wi-night-alt-cloudy", // Partly cloudy
          "176_n": "wi-night-alt-rain", // Patchy rain possible
          "179_n": "wi-night-alt-snow", // Patchy snow possible
          "182_n": "wi-night-alt-sleet", // Patchy sleet possible
          "200_n": "wi-night-alt-thunderstorm", // Thundery outbreaks possible
          "293_n": "wi-night-alt-showers", // Patchy light rain
          "296_n": "wi-night-alt-showers", // Light rain
          "299_n": "wi-night-alt-rain", // Moderate rain at times
          "323_n": "wi-night-alt-snow", // Patchy light snow
          "353_n": "wi-night-alt-showers", // Light rain shower
          "356_n": "wi-night-alt-showers", // Moderate or heavy rain shower
          "362_n": "wi-night-alt-sleet", // Light sleet showers
          "365_n": "wi-night-alt-sleet", // Moderate or heavy sleet showers
          "368_n": "wi-night-alt-snow", // Light snow showers
          "371_n": "wi-night-alt-snow", // Moderate or heavy snow showers
          "386_n": "wi-night-alt-thunderstorm", // Patchy light rain with thunder
          "392_n": "wi-night-alt-snow-thunderstorm", // Patchy light snow with thunder
        };

        // Get WeatherAPI condition code (last part of the icon URL)
        const weatherApiIcon = parsedData.current.condition.icon;
        const conditionCode = weatherApiIcon
          .split("/")
          .pop()
          .replace(".png", "");
        console.log(weatherApiIcon);

        // Determine if it's day or night
        const isNight = weatherApiIcon.includes("night");
        const weatherIconKey = isNight ? `${conditionCode}_n` : conditionCode;

        // Get corresponding Weather Icons class
        ...
        // Remove src attribute if it exists (since we're using CSS classes now)
        if (weatherIconElement.hasAttribute("src")) {

...
document.addEventListener("DOMContentLoaded", function () {
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
    ...
    <g style="transform: scale(0.6); transform-origin: center;">
      <path class="bgLightTint" id="darkLightTint" fill-rule="evenodd"
        d="M2.089 0L.525 4.175v16.694h5.736V24h3.132l3.127-3.132h4.695l6.26-6.258V0H2.089zm2.086 2.085H21.39v11.479l-3.652 3.652H12l-3.127 3.127v-3.127H4.175V2.085zm5.74 10.437h2.086V5.22H9.915v7.302zm5.735 0h2.086V5.22h-2.086v7.302z"/>
    </g>
  </svg>
  `,
    ],
  ...
  const SHORTCUT_DELETE_BUTTON_HTML = `
            ...
            `;
  const SHORTCUT_REORDER_HANDLE_HTML = `<img src="./svgs/grip-dots-vertical.svg" alt="☰">`;

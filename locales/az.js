...
const az = {
  ...
  // Dialog boxes (alerts)
  confirmWallpaper:
    'Gün üçün divar kağızı olaraq yeni bir şəkil təyin etmək istərdinizmi?',
  confirmRestore:
    'Parametrlərinizi sıfırlamaq istədiyinizə əminsiniz? Bu əməliyyatı geri qaytarmaq mümkün deyil.',

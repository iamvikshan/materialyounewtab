...
const pt = {
  ...
  editShortcutsListInfo:
    'Você pode adicionar novos atalhos clicando no ícone "+" ou editar os existentes clicando no nome ou URL do atalho',
  ...
  motivationalQuotesInfo:
    'Mostrar frases motivacionais abaixo do texto personalizado',
  ...
  chromeThemeInfo:
    'Clique nos tres pontos (⋮) > Mais ferramentas > Personalizar Chrome, depois escolha uma cor que corresponde ao tema da extensão.',
  edgeThemeInfo:
    'Va para Configurações > Aparencia, depois escolha uma cor que corresponde ao tema da extensão.',
  braveThemeInfo:
    'Visite <a href="https://chromewebstore.google.com/category/themes/" target="_blank">Chrome Theme Store</a>, Baixe e aplique o tema que corresponde ao tema da extensão.',
  firefoxThemeInfo:
    'Visite <a href="https://addons.mozilla.org/firefox/themes/" target="_blank">Firefox Themes</a>, Baixe e aplique o tema que corresponde ao tema da extensão.',
  updateFirefoxHomepage: 'Atualizar Pagina Inicial',
  updateFirefoxHomepageInfo:
    'Para mudar sua página inicial como o NewTab, visite <a href="https://github.com/XengShi/materialYouNewTab#-firefox" target="_blank">este link</a> e siga as instruções.',
  ...
  cancelText: 'Cancelar',
  confirmWallpaper:
    'Você gostaria de definir uma nova imagem como seu papel de parede para o dia?',
  confirmRestore:
    'Você tem certeza de que deseja redefinir suas configurações? Esta ação não pode ser desfeita.',
  Nobackgroundset: 'Nenhuma imagem de fundo está atualmente definida.',
  clearbackgroundimage:
    'Você tem certeza de que deseja limpar a imagem de fundo?',
  ProxyDisclaimer:
    'Todos os recursos de proxy estão desativados por padrão.\n\nSe você ativar sugestões de pesquisa e o proxy de contorno CORS, é altamente recomendável hospedar seu próprio proxy para maior privacidade.\n\nPor padrão, o proxy será definido como https://mynt-proxy.rhythmcorehq.com, o que significa que todos os seus dados passarão por este serviço, o que pode levantar preocupações de privacidade.',
  GPSDisclaimer:
    'Os dados da sua localização são usados exclusivamente para fornecer atualizações precisas sobre o clima. Eles são armazenados temporariamente no navegador e não são compartilhados com nenhum serviço de terceiros nem acessíveis a nós.\n\nAo habilitar o GPS, você consente em compartilhar sua localização localmente com a extensão.',
  ...
  deleteBookmark:
    'Você tem certeza de que deseja excluir o favorito "{title}"?',

...
const it = {
  ...
  editShortcutsListInfo:
    'Puoi aggiungere nuove scorciatoie cliccando l\'icona "+" o modificiare le esistenti cliccando il nome della scorciatoia o dell\'URL.',
  ...
  chromeThemeInfo:
    "Clicca sui tre puntini (⋮) > Altri strumenti > Personalizza Chrome, quindi scegli un colore che si abbini al tema dell'estensione.",
  edgeThemeInfo:
    "Vai su Impostazioni > Aspetto, quindi scegli un colore che si abbini al tema dell'estensione.",
  braveThemeInfo:
    'Visita <a href="https://chromewebstore.google.com/category/themes/" target="_blank">Chrome Theme Store</a>, scarica e applica il tema che corrisponde all\'estensione.',
  firefoxThemeInfo:
    'Visita <a href="https://addons.mozilla.org/firefox/themes/" target="_blank">Temi di Firefox</a>, scarica e applica il tema che corrisponde all\'estensione.',
  updateFirefoxHomepage: 'Aggiorna Homepage',
  updateFirefoxHomepageInfo:
    'Per cambiare la tua homepage come la nuova scheda, visita <a href="https://github.com/XengShi/materialYouNewTab#-firefox" target="_blank">questo link</a> e segui le istruzioni.',
  ...
  confirmRestore:
    'Sei sicuro di voler reimpostare le impostazioni? Questa azione non può essere annullata.',
  ...
  UnsupportedBrowser:
    'I segnalibri non sono supportati nel tuo browser "{title}"?',
};

...
const zh_TW = {
  ...
  editShortcutsListInfo:
    '您可以透過點擊“+”圖示新增新的捷徑，或透過點擊捷徑名稱或 URL 來編輯現有捷徑',
  ...
  chromeThemeInfo:
    '點擊右上角的三個點 (⋮) > 更多工具 > 自訂 Chrome，然後選擇與擴充套件主題相符的顏色。',
  edgeThemeInfo: '前往設定 > 外觀，然後選擇與擴充套件主題相符的顏色。',
  braveThemeInfo:
    '造訪 <a href="https://chromewebstore.google.com/category/themes/" target="_blank">Chrome 主題商店</a>，下載並套用與擴充套件相符的主題。',
  firefoxThemeInfo:
    '造訪 <a href="https://addons.mozilla.org/firefox/themes/" target="_blank">Firefox 主題</a>，下載並套用與擴充套件相符的主題。',
  updateFirefoxHomepage: '更新首頁',
  updateFirefoxHomepageInfo:
    '若要將首頁更改為與新分頁相同，請造訪 <a href="https://github.com/XengShi/materialYouNewTab#-firefox" target="_blank">此連結</a> 並按照指示操作。',
  ...
  GPSDisclaimer:
    '您的位置資料僅用於提供準確的天氣更新。資料會暫時儲存在瀏覽器內，不會與任何第三方共享或供我們存取。\n\n啟用 GPS 即表示您同意與擴充功能共享您的位置資料。',
  failedbackup: '備份失敗：',

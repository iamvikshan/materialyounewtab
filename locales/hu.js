...
const hu = {
  ...
  editShortcutsListInfo:
    'Új parancsikonokat adhatsz hozzá a "+" ikonra kattintva, vagy szerkesztheted a meglévőket a parancsikon nevére vagy URL címére kattintva.',
  ...
  // Dialog boxes (alerts)
  confirmWallpaper:
    'Szeretnél egy újabb képet beállítani a napi háttérképednek?',
  confirmRestore:

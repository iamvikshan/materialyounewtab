...
const sl = {
  ...
  editShortcutsListInfo:
    'Dodate lahko nove bližnjice s klikom na ikono "+" ali uredite obstoječe s klikom na ime bližnjice ali URL.',
  ...
  deleteBookmark:
    'Ali ste prepričani, da želite odstraniti zaznamek "{title}"?',

...
const fr = {
  ...
  editShortcutsListInfo:
    "Vous pouvez ajouter de nouveaux raccourcis en cliquant sur l'icône « + » ou modifier les raccourcis existants en cliquant sur le nom ou l'URL du raccourci.",
  adaptiveIconText: 'Icônes Adaptatives',
  adaptiveIconInfoText:
    "L'icône du raccourci correspondra à la couleur du thème et apparaîtra plus petite",
  ...
  minMaxTempSubText:
    "Remplacer 'Ressenti' par la température minimale et maximale",
  ...
  hideSearchWithInfo:
    "Passez d'un moteur de recherche à l'autre en cliquant sur son icône",
  ...
  useGPSInfo:
    'Activer le GPS pour des mises à jour en temps réel de la localisation',
  ...
  chromeThemeInfo:
    "Clquez sur les trois points (⋮) > Plus d'outils > Personnaliser Chrome, puis choisissez une couleur qui correspond au thème de l'extension.",
  edgeThemeInfo:
    "Aller dans Paramètres > Apparence, puis choisissez une couleur qui correspond au thème de l'extension.",
  braveThemeInfo:
    'Visitez <a href="https://chromewebstore.google.com/category/themes/" target="_blank">Chrome Theme Store</a>, telecharger et appliquer le thème qui correspond au thème de l\'extension.',
  firefoxThemeInfo:
    'Visitez <a href="https://addons.mozilla.org/firefox/themes/" target="_blank">Firefox Themes</a>, telecharger et appliquer le thème qui correspond au thème de l\'extension.',
  updateFirefoxHomepage: "Mettre à jour la page d'accueil",
  updateFirefoxHomepageInfo:
    'Pour changer votre page d\'accueil comme le nouvel onglet, visitez <a href="https://github.com/XengShi/materialYouNewTab#-firefox" target="_blank">ce lien</a> et suivez les instructions.',
  ...
  cancelText: 'Annuler',
  confirmWallpaper:
    "Souhaitez-vous définir une nouvelle image comme fond d'écran pour la journée?",
  confirmRestore:
    'Êtes-vous sûr de vouloir réinitialiser vos paramètres? Cette action ne peut être annulée.',
  ...
  UnsupportedBrowser:
    'Les favoris ne sont pas supportés dans votre navigateur.',
};

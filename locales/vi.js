...
const vi = {
  ...
  editShortcutsListInfo:
    'Bạn có thể thêm phím tắt mới bằng cách nhấp vào biểu tượng "+" hoặc chỉnh sửa phím tắt hiện có bằng cách nhấp vào tên phím tắt hoặc URL.',
  ...
  hideSearchWithInfo:
    'Chuyển đổi giữa các công cụ tìm kiếm bằng cách nhấp vào biểu tượng của nó',
  ...
  // Dialog boxes (alerts)
  confirmWallpaper:
    'Bạn có muốn đặt một hình ảnh mới làm hình nền cho ngày không?',
  confirmRestore:
    'Bạn có chắc chắn muốn đặt lại cài đặt của mình không? Hành động này không thể hoàn tác.',

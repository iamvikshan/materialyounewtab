...
const en = {
  ...
  adaptiveIconInfoText:
    'Shortcut icons will match the theme color and appear smaller',
  ...
  minMaxTempSubText:
    "Replace 'Feels Like' with minimum and maximum temperature",
  ...
  chromeThemeInfo:
    'Click the three dots (⋮) > More tools > Customize Chrome, then choose a color that matches the extension theme.',
  edgeThemeInfo:
    'Goto Settings > Appearance, then choose a color that matches the extension theme.',
  braveThemeInfo:
    'Visit <a href="https://chromewebstore.google.com/category/themes/" target="_blank">Chrome Theme Store</a>, download and apply the theme that matches the extension.',
  firefoxThemeInfo:
    'Visit <a href="https://addons.mozilla.org/firefox/themes/" target="_blank">Firefox Themes</a>, download and apply the theme that matches the extension.',
  updateFirefoxHomepage: 'Update Homepage',
  updateFirefoxHomepageInfo:
    'To change your homepage like the new tab as well, visit <a href="https://github.com/XengShi/materialYouNewTab#-firefox" target="_blank">this link</a> and follow the instructions.',
  ...
  cancelText: 'Cancel',
  confirmWallpaper:
    'Would you like to set a new image as your wallpaper for the day?',
  confirmRestore:
  ...
  GPSDisclaimer:
    'Your location data is used solely to provide accurate weather updates. It is temporarily stored within the browser and neither shared with any third-party services nor accessible to us.\n\nBy enabling GPS, you consent to sharing your location with the extension locally.',

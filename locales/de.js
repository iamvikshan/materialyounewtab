...
const de = {
  ...
  editShortcutsListInfo:
    'Sie können neue Verknüpfungen hinzufügen, indem Sie auf das Symbol „+“ klicken, oder vorhandene Verknüpfungen bearbeiten, indem Sie auf den Namen oder die URL der Verknüpfung klicken.',
  adaptiveIconText: 'Adaptive Symbole',
  adaptiveIconInfoText:
    'Verknüpfungssymbole passen sich der Farbe des Themas an und erscheinen kleiner',
  ...
  hideSearchWithInfo:
    'Wechseln Sie zwischen Suchmaschinen, indem Sie auf das Symbol klicken',
  ...
  adjustZoomInfo:
    'Drücken Sie Strg + „+“ oder Strg + „-“, um den Zoom anzupassen.',
  changeBrowserTheme: 'Browserthema ändern',
  chromeThemeInfo:
    'Klicken Sie auf die drei Punkte (⋮) > Weitere Tools > Chrome anpassen und wählen Sie dann eine Farbe, die zum Thema der Erweiterung passt.',
  edgeThemeInfo:
    'Gehen Sie zu Einstellungen > Aussehen und wählen Sie dann eine Farbe, die zum Thema der Erweiterung passt',
  braveThemeInfo:
    'Besuchen Sie <a href="https://chromewebstore.google.com/category/themes/" target="_blank">Chrome Theme Store</a>, laden Sie das zur Erweiterung passende Theme herunter und wenden Sie es an.',
  firefoxThemeInfo:
    'Besuchen Sie <a href="https://addons.mozilla.org/firefox/themes/" target="_blank">Firefox Themes</a>, laden Sie das zur Erweiterung passende Theme herunter und wenden Sie es an.',
  updateFirefoxHomepage: 'Homepage aktualisieren',
  updateFirefoxHomepageInfo:
    'Um Ihre Homepage wie auch den neuen Tab zu ändern, besuchen Sie <a href="https://github.com/XengShi/materialYouNewTab#-firefox" target="_blank">diesen Link</a> und folgen Sie den Anweisungen.',
  ...
  confirmWallpaper:
    'Möchten Sie ein neues Bild als Hintergrundbild für den heutigen Tag festlegen?',
  confirmRestore:
    'Sind Sie sicher, dass Sie Ihre Einstellungen zurücksetzen wollen? Diese Aktion kann nicht rückgängig gemacht werden.',
  ...
  deleteBookmark:
    'Sind Sie sicher, dass Sie das Lesezeichen „{title}“ löschen wollen?',

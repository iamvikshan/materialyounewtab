...
const hi = {
  ...
  editShortcutsListInfo:
    'आप "+" आइकन पर क्लिक करके नए शॉर्टकट्स जोड़ सकते हैं या शॉर्टकट के नाम या URL पर क्लिक करके मौजूदा शॉर्टकट्स को संपादित कर सकते हैं।',
  adaptiveIconText: 'अनुकूलनीय आइकन',
  adaptiveIconInfoText:
    'शॉर्टकट आइकन थीम रंग से मेल खाते हुए छोटे आकार में दिखेंगे',
  ...
  chromeThemeInfo:
    'तीन बिंदु (⋮) पर क्लिक करें > अधिक टूल्स > क्रोम को कस्टमाइज़ करें, फिर एक्सटेंशन थीम से मेल खाने वाला रंग चुनें।',
  edgeThemeInfo:
    'सेटिंग्स > रूपरंग (Appearance) पर जाएं, फिर एक्सटेंशन थीम से मेल खाने वाला रंग चुनें।',
  braveThemeInfo:
    ' <a href="https://chromewebstore.google.com/category/themes/" target="_blank">क्रोम थीम स्टोर</a> पर जाएं, उपयुक्त थीम डाउनलोड करें और लागू करें।',
  firefoxThemeInfo:
    '<a href="https://addons.mozilla.org/firefox/themes/" target="_blank">फ़ायरफ़ॉक्स थीम्स</a> पर जाएँ, अपनी पसंद की थीम डाउनलोड करें और उसे लागू करें।',
  updateFirefoxHomepage: 'होमपेज अपडेट करें',
  updateFirefoxHomepageInfo:
    'अपने होमपेज को भी नए टैब की तरह बदलने के लिए, <a href="https://github.com/XengShi/materialYouNewTab#-firefox\" target="_blank">इस लिंक</a> पर जाएं और दिए गए निर्देशों का पालन करें।',

...
const bn = {
  ...
  editShortcutsListInfo:
    '"+" আইকনে ক্লিক করে নতুন শর্টকাট যোগ করুন অথবা বিদ্যমান শর্টকাটের নাম বা URL-এ ক্লিক করে সম্পাদনা করুন।',
  adaptiveIconText: 'অ্যাডাপ্টিভ আইকন',
  adaptiveIconInfoText:
    'শর্টকাট আইকন থিম রঙের সাথে মিলে ছোট আকারে প্রদর্শিত হবে',
  ...
  minMaxTempSubText:
    'অনুভূতি তাপমাত্রার পরিবর্তে সর্বনিম্ন ও সর্বাধিক তাপমাত্রা দেখান',
  ...
  hideSearchWithInfo:
    'সার্চ ইঞ্জিনের আইকনে ক্লিক করে সার্চ ইঞ্জিন পরিবর্তন করুন',
  ...
  chromeThemeInfo:
    'তিনটি ডট (⋮) এ ক্লিক করুন > আরও টুলস > ক্রোম কাস্টমাইজ করুন, তারপর এক্সটেনশনের থিমের সাথে মিলিয়ে একটি রঙ নির্বাচন করুন।',
  edgeThemeInfo:
    'সেটিংসে যান > রূপ, তারপর এক্সটেনশনের থিমের সাথে মিলিয়ে একটি রঙ নির্বাচন করুন।',
  braveThemeInfo:
    '<a href="https://chromewebstore.google.com/category/themes/" target="_blank">ক্রোম থিম স্টোর</a> এ যান, থিম ডাউনলোড করুন এবং এক্সটেনশনের থিমের সাথে মিলিয়ে একটি রঙ নির্বাচন করুন।',
  firefoxThemeInfo:
    '<a href="https://addons.mozilla.org/firefox/themes/" target="_blank">ফায়ারফক্স থিম</a> এ যান, থিম ডাউনলোড করুন এবং এক্সটেনশনের থিমের সাথে মিলিয়ে একটি রঙ নির্বাচন করুন।',
  updateFirefoxHomepage: 'হোমপেজ আপডেট করুন',
  updateFirefoxHomepageInfo:
    'আপনার হোমপেজকে নতুন ট্যাবের মতো পরিবর্তন করতে, <a href="https://github.com/XengShi/materialYouNewTab#-firefox" target="_blank">এই লিংকে</a> যান এবং নির্দেশিকা অনুসরণ করুন।',
  ...
  confirmWallpaper:
    'আপনি কি আজকের জন্য একটি নতুন ছবি ওয়ালপেপার হিসেবে সেট করতে চান?',
  confirmRestore:
    'আপনি কি নিশ্চিত যে আপনি আপনার সেটিংস রিসেট করতে চান? এটি পূর্বাবস্থায় ফেরানো যাবে না।',
  ...
  deleteBookmark:
    'আপনি কি নিশ্চিত যে আপনি "{title}" বুকমার্কটি মুছে ফেলতে চান?',
